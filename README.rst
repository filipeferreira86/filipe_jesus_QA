...
My aproach for this test was to do it as simple and reusable as possible, so the idea is that ussing this script you should be able to test any error messagem for login page just by changing the parameters in the feature file.
